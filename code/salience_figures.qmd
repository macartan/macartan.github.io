---
title: "Political salience, endogenous bandwagoning, and regime resilience: Replication code for figures"
author: Sebastian Schweighofer-Kodritsch, Steffen Huck, Macartan Humphreys
format: 
  html:
...
Replication code for figures in @Schweighofer-Kodritsch_Huck_Humphreys_2025_salience.
...
```{r piv, echo = TRUE, fig.cap = "\\label{mu} Illustration of $\\mu$", fig.align="center", out.width = "75%", include = TRUE}
...
```{r eq, fig.height = 6, fig.width = 9, echo = TRUE, fig.align="center", fig.cap = "\\label{eq} Equilibria in a linear-uniform model.", out.width = "100%"}
...
# Figure 3: Equilibria given costs

Illustration of (unique) interior equilibria as a function of $\rho_D \in [0, 1]$ when $\rho_A = 1$, for six different values of $\sigma$...

```{r eqc, fig.height = 5, fig.width = 7, echo = TRUE, fig.align="center", fig.cap = "Share attacking given sanctions", out.width = "100%"}
ra <- 1
...
# Figure 4: Many equilibria illustration

Equilibria as a function of $\sigma$ over the range $[0, 0.6]$ for the same example...

```{r many2, echo = TRUE, fig.cap = "\\label{many2} Summary of equilibria as a function of $\\sigma$ for the same parameters as in Figure 1.", fig.align="center"}
ra <- 0.5
rd <- 0.45
m0 <- rd / (rd + ra)
sigtop <- 0.6
