...
So the evergreen advice [@lundberg2021your], but especially important when using a survey experiment: be sure to know your estimand. 
...
The next section clarifies concepts, the following section walks through different survey types, the final section clarifies the difficulties of making inferences about effects estimates in a conjoint survey experiment to effects of actual attributes on actual vote shares, even when experiment design closely mimics the features of target elections.
