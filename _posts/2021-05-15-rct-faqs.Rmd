...
output: 
  html_document:
    keep_md: true
description: "This document is written as a helper for practitioners and others reading analyses of RCTs. It's informal and skips over some nuance, but links to pointers to more technical treatments. This is a living document and will be updated as more questions (or answers) come.<br><br>"
---
...
**Probably not**.^[The rare cases in which you might worry are if the design used a randomization procedure --- such as assigning different units with different probabilities --- that calls for adjustment at the analysis stage.] See [here](#nocontrols). Even if you have imbalance on one or more background covariates (see [here](#imbalance)).
